...
(function (Assets) {
    ...
    (function (Sound) {
        var Effect;
        (function (Effect) {
            Effect.explosion = '/assets/sfx/47252__nthompson__rocketexpl.mp3';
            Effect.thunder = '/assets/sfx/2523__rhumphries__rbh-thunder-storm.mp3';
            Effect.rain = '/assets/sfx/7521__abinadimeza__rainfall.mp3';
            Effect.footstep_right = '/assets/sfx/9907__snoman__grass4_alt.mp3';
            Effect.footstep_left = '/assets/sfx/9907__snoman__grass4.mp3';
            Effect.crate_break = '/assets/sfx/66777__kevinkace__crate-break-1.mp3';
            Effect.water_splash = '/assets/sfx/20433__agfx__water-slosh-spashing-3.mp3';
        })(Effect || (Effect = {}));
        var Music;
        (function (Music) {
